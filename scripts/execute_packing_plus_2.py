...
def main():
    ...
    print("Extracting KPIs for Packing +2 scenario...")
    ...
    summary = extractor.generate_summary("packing_plus_2", order_metrics)
    ...
    os.makedirs("data/results/scenarios/packing_plus_2", exist_ok=True)
    
    order_metrics.to_parquet("data/results/scenarios/packing_plus_2/packing_plus_2_order_metrics.parquet", index=False)
    stage_metrics.to_parquet("data/results/scenarios/packing_plus_2/packing_plus_2_stage_metrics.parquet", index=False)
    
    with open("data/results/scenarios/packing_plus_2/packing_plus_2_kpis.json", "w") as f:
        json.dump(summary, f, indent=4)
        
    with open("data/results/scenarios/packing_plus_2/packing_plus_2_execution_metadata.json", "w") as f:
    ...
    with open("data/results/scenarios/baseline_vs_packing_plus_2.json", "w") as f:

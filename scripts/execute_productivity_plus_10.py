...
def main():
    ...
    print("Extracting KPIs for Productivity +10 scenario...")
    ...
    summary = extractor.generate_summary("productivity_plus_10", order_metrics)
    ...
    os.makedirs("data/results/scenarios/productivity_plus_10", exist_ok=True)
    
    order_metrics.to_parquet("data/results/scenarios/productivity_plus_10/productivity_plus_10_order_metrics.parquet", index=False)
    stage_metrics.to_parquet("data/results/scenarios/productivity_plus_10/productivity_plus_10_stage_metrics.parquet", index=False)
    
    with open("data/results/scenarios/productivity_plus_10/productivity_plus_10_kpis.json", "w") as f:
        json.dump(summary, f, indent=4)
        
    with open("data/results/scenarios/productivity_plus_10/productivity_plus_10_execution_metadata.json", "w") as f:
    ...
    with open("data/results/scenarios/baseline_vs_productivity_plus_10.json", "w") as f:
